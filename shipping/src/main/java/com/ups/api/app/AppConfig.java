...
public class AppConfig {
	...
	public static final String SHIPPING_SUCCESS = "ShippingSuccess";
	public static final String LABEL_RECOVERY_SUCCESS = "LabelRecoverySuccess";
	...
	@Value("${api.shipping.base.url:#{null}}")
	private String shippingBaseUrl;

	@Value("${api.shipping.version:v1}")
	private String shippingVersion;

	@Value("${api.shipping.transaction.source:testing}")
	private String transactionSrc;

	@Value("#{${api.shipping.scenario.properties}}")
	private Map<String, List<String>> scenarioProperties;

	@Value("#{${api.label.recovery.scenario.properties}}")
	private Map<String, List<String>> labelRecoveryScenarioProperties;
