...
public class AppConfig {
	...
	//@Value("${api.oauth.partner.accessToken}")
	...
	@Value("${api.quantumView.base.url:#{null}}")
	private String quantumViewBaseUrl;
	
	@Value("${api.quantumView.version:v1}")
	private String quantumViewVersion;

	@Value("${api.quantumView.transaction.source:testing}")
	private String transactionSrc;
	
	@Value("#{${api.quantumView.scenario.properties}}")
	...
	public static final String QUANTUM_VIEW_REQUEST_BY_NAME_SUCCESS_SCENARIO = "QuantumViewRequestByNameSuccess";

	public static final String QUANTUM_VIEW_REQUEST_BY_DATE_RANGE_SUCCESS_SCENARIO = "QuantumViewRequestByDateRangeSuccess";
