...
public class LandedCostDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
            ...
            for (Map.Entry<String, List<String>> entry : appConfig.getScenarioProperties().entrySet()) {
                try {
                    ...
                    processResultLandedCostResponse(entry.getKey(), landedcostResponseWrapper.getLandedCostResponse());
    ...
    public LANDEDCOSTResponseWrapper sendRequest(final LANDEDCOSTRequestWrapper landedcostRequestWrapper, final String transId) {
